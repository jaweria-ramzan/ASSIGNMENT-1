...
//Question#43
//Unchanged Magicians
let magiciansName1 = ["Adele", "Michael", "Deniz", "Ken", "Beyonce"]; //original
for (let n = 0; n < magiciansName1.length; n++) {
    console.log(magiciansName1[n]);
}
const modifiedMagicians1 = [];
function make_great1(magiciansName1) {
...
;
function show_magicians1(magiciansName1) {
    for (let n = 0; n < magiciansName1.length; n++) {
        console.log(magiciansName1[n]);
    }
}
